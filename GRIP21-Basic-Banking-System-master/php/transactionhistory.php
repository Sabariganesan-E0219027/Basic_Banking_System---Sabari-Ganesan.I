...
<body>
    ...
    include './navbar.php';
    ?>
    <div class="center mt-0 #E71989 orange red darken-3">
        <h3><b><span><img src="https://www.freelogodesign.org/file/app/client/thumb/f2e9bea9-ecfa-4cbf-a140-b2a332c9cc3d_200x200.png?1613582321182" style="height:60px;width:50px" /></span>Transaction History</b></h3>
    </div>
    <div class="container" >
        <br>
